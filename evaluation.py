...
def f1_score(y_true, y_pred):
    """
        ...
        :return: f1_score of binary classification task with true labels y_true and predicted labels y_pred
    """
...
def rmse(y_true, y_pred):
    """
        ...
        :param y_true: the true labels
        :param y_pred: the predicted labels
        :return: RMSE of regression task with true labels y_true and predicted labels y_pred
    """
